...
const DomModificationPage = () => {
    ...
    // Quel est le type "TypeScript" a utiliser ? => <p>
    ...
    const changeTitleColor = (color: string) => {
        ...
        if (title != null) {
            ...
            // il est possible d'accéder au style d'un élément HTML en faisant : title.style. Ceci provient du JS.
            // plus d'information sur la modification de la couleur en JS : https://www.w3schools.com/jsref/prop_style_color.asp
            title.style.color = color; // Changement réel de la couleur
        }
    };
    ...
    const toggleParagraphStyle = () => {
        ...
        if (paragraph != null) {
            ...
            if (isHighlighted) { // si c'est bien "highlighted"
                ...
                paragraph.classList.toggle(styles.highlighted); // retire highlighted
                paragraph.classList.add(styles.normal); // ajoute normal
            } else {
                // TODO insérer un toggle pour passer en highlighted
                paragraph.classList.toggle(styles.highlighted); // ajoute highlighted
                paragraph.classList.remove(styles.normal); // retire normal
            }
        }
        //// Penser à "attacher" la ref à l'element concerné => <p ref={paragraphRef} className={styles.paragraph + ' ' + styles.normal}></p> 
    };
    ...
    return (
        <div className={styles.container}>
            ...
            <p ref={paragraphRef} className={styles.paragraph + ' ' + styles.normal}> // Penser à "attacher" la ref à l'element concerné
